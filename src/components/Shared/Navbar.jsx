...
export default function Navbar() {
  ...
  const linkInactive = isHome ? "text-white/90 hover:text-white" : "text-gray-600 hover:text-gray-900";
      ...
      <div className="hidden sm:block w-full text-[13px]">
        <div className={`${shellInner} flex items-center justify-between py-2`}>
          ...
          <div className={`flex items-center gap-4 ${iconCls}`}>
            <Link to="/facebook" aria-label="Facebook" className="hover:opacity-80">
            ...
            <Link to="/twitter" aria-label="Twitter/X" className="hover:opacity-80">
            ...
            <Link to="/behance" aria-label="Behance" className="hover:opacity-80">
        ...
        <div className={shellInner}>
          <div className={shellBox}>
            <div className="flex items-center justify-between px-4 py-3">
              {/* Brand */}
              <Link to="/" className={`${brandCls} font-extrabold tracking-wide text-2xl`}>
                GEICS Travel
              </Link>
              ...
              <>
                ...
                <div
                  ...
                  className={`lg:hidden z-50 border-t px-4 pb-4 relative backdrop-blur-md
                    ${isHome ? "border-white/10 bg-black/60" : "border-gray-200 bg-white/90"}`}
                >
                      ...
                      <div className="pl-3 space-y-1">
                        <Link
                          ...
                          className={`block px-2 py-2 rounded-md ${
                            isHome ? "text-white/90 hover:bg-white/10" : "text-gray-700 hover:bg-gray-50"
                          }`}
                        >
                          Travel Tips
                        </Link>
