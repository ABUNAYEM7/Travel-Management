    ...
    <div className="bg-white">
      ...
      <section className="py-16 sm:py-20 bg-slate-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-gray-500 text-center max-w-3xl mx-auto">
          ...
          <div className="mt-10 grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-4">
            {FEATURES.map((f) => (
              ...
              >
                ...
                <p className="mt-2 text-gray-600 leading-7 text-[15px]">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {PLANS.map((p) => (
              <div
                ...
                } bg-white p-6 sm:p-8 shadow-sm`}
              >
                <div className="flex items-start justify-between">
                  <div>
                    <h3 className="text-xl font-extrabold text-gray-900">{p.name}</h3>
                    <p className="mt-1 text-sm text-gray-500">{p.badge}</p>
                  </div>
                  {p.highlight && (
                ...
                <div className="mt-8">
                  <Link
                    to="/contact"
                    className={`inline-flex items-center justify-center rounded-md px-5 py-2.5 font-semibold transition ${
                      p.highlight
